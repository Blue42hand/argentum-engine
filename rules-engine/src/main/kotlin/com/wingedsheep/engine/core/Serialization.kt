...
val engineSerializersModule = SerializersModule {
    ...
    polymorphic(GameEvent::class) {
        ...
        subclass(CreaturesPairedEvent::class)
        ...
        subclass(CardExiledWithMadnessEvent::class)
        ...
        subclass(PermanentConnivedEvent::class)
    ...
    polymorphic(AnswerContinuation::class) {
        ...
        subclass(CounterUnlessPlayerCountersContinuation::class)
        subclass(WardCostChoiceContinuation::class)
    ...
    polymorphic(Component::class) {
        ...
        subclass(DealtDamageToThisGameComponent::class)
        subclass(EnteredWithValueComponent::class)
        subclass(TimestampComponent::class)
        subclass(BattlefieldEntryTimestampComponent::class)
        subclass(AbilityActivatedEverComponent::class)
        subclass(ChosenModesEverComponent::class)
        subclass(ChosenModesThisTurnComponent::class)
        ...
        subclass(ChosenLinkedExileComponent::class)
        subclass(NotedExileComponent::class)
        ...
        subclass(MayCastFromGraveyardUsedThisTurnComponent::class)
        ...
        subclass(DamageSourcesThisTurnComponent::class)
