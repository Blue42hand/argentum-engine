...
sealed interface SourceFilter {
     ...
     * [Recipient.Self] for the source side. Used by static foggers like Fog Bank
     ...
     * creature. Source-side mirror of [Recipient.EnchantedCreature].
     */
     ...
     * Thor). Source-side mirror of [Recipient.EquippedCreature].
     *
     * Resolves identically to [EnchantedCreature] (both read the host's attachment), and the two
     * share a branch in the engine's source matcher exactly as the [Recipient] pair does.
