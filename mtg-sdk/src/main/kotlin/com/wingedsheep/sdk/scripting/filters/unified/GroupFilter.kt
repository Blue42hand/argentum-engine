...
data class GroupFilter(
    ...
    /** Must have a counter of the given type (e.g. `CounterType.PLUS_ONE_PLUS_ONE`) */
    fun withCounter(counterType: CounterType) = copy(baseFilter = baseFilter.withCounter(counterType))
