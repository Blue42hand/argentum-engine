...
val SkirkFireMarshal = card("Skirk Fire Marshal") {
    ...
    activatedAbility {
        cost = Costs.TapPermanents(5, GameObjectFilter.Permanent.withSubtype("Goblin"))
        effect = Effects.ForEachInGroup(GroupFilter.AllCreatures, DealDamageEffect(10, EffectTarget.IterationEntity)) then Effects.ForEachPlayer(Player.Each, listOf(Effects.DealDamage(10, EffectTarget.Controller)))
    }
