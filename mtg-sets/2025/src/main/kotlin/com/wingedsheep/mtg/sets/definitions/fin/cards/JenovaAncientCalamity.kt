 ...
 *
 * The combat trigger uses `Triggers.you.beginningOf(Step.BEGIN_COMBAT)`; the target is "up to one other target
 ...
 *
 * The dies payoff mirrors Rakdos Joins Up: a `Triggers.<subject>.leaves(to, excludeTo, excludeSacrifice)` (… to GRAVEYARD)
...
val JenovaAncientCalamity = card("Jenova, Ancient Calamity") {
    ...
    triggeredAbility {
        trigger = Triggers.a(GameObjectFilter.Creature.withSubtype("Mutant").youControl()).dies()
