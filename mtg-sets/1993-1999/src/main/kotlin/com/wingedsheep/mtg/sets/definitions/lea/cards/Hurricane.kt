...
val Hurricane = card("Hurricane") {
    ...
    spell {
        effect = Effects.ForEachInGroup(GroupFilter.AllCreatures.withKeyword(Keyword.FLYING), Effects.DealDamage(DynamicAmount.XValue, EffectTarget.IterationEntity)) then
