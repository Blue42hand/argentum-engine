...
val GatheringStone = card("Gathering Stone") {
    ...
    staticAbility {
        ability = ModifySpellCost(
            target = SpellCostTarget.YouCast(GameObjectFilter.Any.withChosenSubtype()),
    ...
    val lookAtTopEffect = Effects.Pipeline {
        ...
        move(toHandCards, CardDestination.ToZone(Zone.HAND), revealed = true, revealToSelf = false)
        ...
        toGraveyard(nonMatchToGraveyard)
    }
