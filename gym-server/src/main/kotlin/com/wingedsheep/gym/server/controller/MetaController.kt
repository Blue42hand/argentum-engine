 ...
 *  - `GET /status` — inspectable service/schema/build identity for remote clients.
 */
@RestController
...
class MetaController(
    ...
    @Operation(
        summary = "Service status and build identity",
        description = "Returns stable service identity, observation schema hash, and the deployment-supplied build revision."
    )
    @GetMapping("/status")
