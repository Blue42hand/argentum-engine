...
Actuator metrics are process-local and reset when the Gym server restarts. They intentionally do not contain Commander Gym strategy, model data, deck-specific behavior, or deployment credentials.
